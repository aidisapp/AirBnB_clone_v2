...
class test_Amenity(test_basemodel):
    """Test the base model of amenities class"""
...
class test_inherit_basemodel(unittest.TestCase):
    """Test if user inherit from BaseModel class"""

    def test_instance(self):
        """check if user is an instance of BaseModel class"""
        user = Amenity()
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_user_id_and_createat(self):
        """testing id attribute for every user"""
        user_1 = Amenity()
        sleep(2)
        user_2 = Amenity()
        sleep(2)
    ...
    def test_save_method(self, mock_storage):
        """Test the save method and if it updates correctly"""
        instance5 = Amenity()
